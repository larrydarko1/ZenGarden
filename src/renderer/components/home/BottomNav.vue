...
<template>
    <nav class="bottom-nav">
        ...
        <button
            class="nav-item"
            :class="[{ 'nav-active': philosophyMode }]"
            aria-label="About our philosophy"
            @click="$emit('toggle-philosophy')">
            <svg
                width="22"
                height="22"
                viewBox="0 0 96 96"
...
@keyframes nav-indicator-in {
    ...
    to {
        transform: translateX(-50%) scaleX($scale-100);
        opacity: $opacity-mid;
    }
}
